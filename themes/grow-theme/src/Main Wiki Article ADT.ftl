...
<script type="text/javascript">
	$(document).ready(function () {
		...
		var isFavouriteAndLikedApi = portalUrl + "/o/favourites/isFavouriteAndLikedArray?p_auth=" + Liferay.authToken + "&groupId=" + window.groupId + "&userId=" + window.userId + "&assetEntryId=" + window.assetEntryId;
		...
		document.querySelector(".grow-wiki-body #likeButton").addEventListener('click', function(event){
			...
			if (window.isLiked) {
				var api = window.portalUrl + "/o/favourites/removeAssetLike?p_auth=" + Liferay.authToken + "&assetEntryId=" + window.assetEntryId + "&userId=" + window.userId;
				...
				var api = window.portalUrl + "/o/favourites/addAssetLike?p_auth=" + Liferay.authToken + "&assetEntryId=" + window.assetEntryId + "&rank=1&userId=" + window.userId;
				var body ={
		...
		document.querySelector(".grow-wiki-body #favouriteButton").addEventListener('click', function(event){ 
			...
			if (window.isFavourite) {
				var api = window.portalUrl + "/o/favourites/removeFavourite?p_auth=" + Liferay.authToken + "&groupId=" + window.groupId + "&userId=" + window.userId + "&assetEntryId=" + window.assetEntryId;
				var body ={
						method: 'DELETE', // *GET, POST, PUT, DELETE, etc.
						mode: 'cors', // no-cors, cors, *same-origin
						credentials: 'same-origin', // include, *same-origin, omit
				...
				var api = window.portalUrl + "/o/favourites/addFavourite?p_auth=" + Liferay.authToken + "&groupId=" + window.groupId + "&userId=" + window.userId + "&assetEntryId=" + window.assetEntryId;
				var body ={
						method: 'PUT', // *GET, POST, PUT, DELETE, etc.
						mode: 'cors', // no-cors, cors, *same-origin
						credentials: 'same-origin', // include, *same-origin, omit
