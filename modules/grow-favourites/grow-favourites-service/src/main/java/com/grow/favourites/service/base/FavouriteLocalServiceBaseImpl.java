...
package com.grow.favourites.service.base;
...
/**
 * Provides the base implementation for the favourite local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.grow.favourites.service.impl.FavouriteLocalServiceImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public abstract class FavouriteLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements FavouriteLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.grow.favourites.service.FavouriteLocalServiceUtil} to access the favourite local service.
	 */
	...
	public Favourite addFavourite(Favourite favourite) {
		...
		return favouritePersistence.update(favourite);
	}
	...
	public Favourite createFavourite(long favouriteId) {
		return favouritePersistence.create(favouriteId);
	}
	...
	public Favourite deleteFavourite(long favouriteId)
		...
		return favouritePersistence.remove(favouriteId);
	}
	...
	public Favourite deleteFavourite(Favourite favourite) {
		return favouritePersistence.remove(favourite);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Favourite.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return favouritePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return favouritePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return favouritePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public Favourite fetchFavourite(long favouriteId) {
		return favouritePersistence.fetchByPrimaryKey(favouriteId);
	}
	...
	public Favourite fetchFavouriteByUuidAndGroupId(String uuid, long groupId) {
		return favouritePersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public Favourite getFavourite(long favouriteId) throws PortalException {
		return favouritePersistence.findByPrimaryKey(favouriteId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(favouriteLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Favourite.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("favouriteId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(favouriteLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Favourite.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("favouriteId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return favouriteLocalService.deleteFavourite((Favourite)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return favouritePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Favourite> getFavouritesByUuidAndCompanyId(String uuid,
		long companyId) {
		return favouritePersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<Favourite> getFavouritesByUuidAndCompanyId(String uuid,
		...
		return favouritePersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
	...
	public Favourite getFavouriteByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {
		return favouritePersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<Favourite> getFavourites(int start, int end) {
		return favouritePersistence.findAll(start, end);
	}
	...
	public int getFavouritesCount() {
		return favouritePersistence.countAll();
	}
	...
	/**
	 * Returns the favourite local service.
	 *
	 * @return the favourite local service
	 */
	public FavouriteLocalService getFavouriteLocalService() {
		return favouriteLocalService;
	}

	/**
	 * Sets the favourite local service.
	 *
	 * @param favouriteLocalService the favourite local service
	 */
	public void setFavouriteLocalService(
		FavouriteLocalService favouriteLocalService) {
		this.favouriteLocalService = favouriteLocalService;
	}

	/**
	 * Returns the favourite persistence.
	 *
	 * @return the favourite persistence
	 */
	public FavouritePersistence getFavouritePersistence() {
		return favouritePersistence;
	}

	/**
	 * Sets the favourite persistence.
	 *
	 * @param favouritePersistence the favourite persistence
	 */
	public void setFavouritePersistence(
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.grow.favourites.model.Favourite",
			favouriteLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.grow.favourites.model.Favourite");
	}
	...
	public String getOSGiServiceIdentifier() {
		return FavouriteLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = favouritePersistence.getDataSource();
	...
	@BeanReference(type = FavouriteLocalService.class)
	protected FavouriteLocalService favouriteLocalService;
	@BeanReference(type = FavouritePersistence.class)
